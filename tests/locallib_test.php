 ...
 * $ vendor/bin/phpunit -v local_initialsprofilepics_testcase local/initialsprofilepics/tests/locallib_test.php
 *
...
class local_initialsprofilepics_testcase extends advanced_testcase {
    ...
    public function test_plugin_enabled() {
        ...
        set_config('enabled', false, 'local_initialsprofilepics');
        $this->assertEquals(0, get_config('local_initialsprofilepics', 'enabled'));
        set_config('enabled', true, 'local_initialsprofilepics');
        $this->assertEquals(1, get_config('local_initialsprofilepics', 'enabled'));
    }

    public function test_basic_picture_checks() {
        global $CFG, $DB;
        require_once($CFG->dirroot . '/local/initialsprofilepics/locallib.php');
        $this->resetAfterTest(true);
    ...
    public function test_get_english_initials() {
        ...
        $res = initialsprofilepics_get_initials_from_user($user);
    ...
    public function test_random_colour_from_pool() {
        ...
        $this->assertContains($colour, INITIALSPROFILEPICS_COLOURS);
    }
    ...
    public function test_working_colour() {
        ...
        $colour = initialsprofilepics_get_working_colour();
    ...
    public function test_random_initials() {
        ...
        $initials = initialsprofilepics_get_random_initials(50);
        foreach ($initials as $initial) {
            $this->assertContains($initial, INITIALSPROFILEPICS_INITIALSPOOL);
        }
    }
    ...
    public function test_colour_from_initials() {
        ...
        for ($j = 1; $j <= 50; $j++) {
            $initials = initialsprofilepics_get_random_initials();
            $this->assertRegExp('/^#(?:[0-9a-fA-F]{3}){1,2}$/', initialsprofilepics_get_colour_from_initials($initials));
        }
    }
    ...
    public function test_image_generation_data() {
        ...
        $newimagedata   = initialsprofilepics_create_and_dump_onscreen($initials, $shape, $colour, $size, $fontsize, $fontalpha);
        ...
        // $newimagedata   = initialsprofilepics_create_and_dump_onscreen(null, null, null, null, null, null);
        // $this->assertEquals($imagedata, $newimagedata);
    }
    ...
    public function test_image_generation_file() {
        ...
        $imagetemp      = initialsprofilepics_save_to_disk($canvas, $user);

        $this->assertFileExists($imagetemp);
        $this->assertFileEquals($imagetemp, $CFG->dirroot . '/local/initialsprofilepics/tests/testimage.png');
    }
